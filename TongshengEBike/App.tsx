    ...
    () => [
      {
        ...
        containerStyle: {width: '95%', backgroundColor: 'white', padding: 10},
        value: 'off',
        size: buttonSize,
      },
      {
        ...
        color: 'black',
        labelStyle: {fontSize: 25, color: 'black'},
        containerStyle: {width: '95%', backgroundColor: '#53af55', padding: 10},
        size: buttonSize,
      },
      {
        id: '3',
        ...
        color: 'black',
        labelStyle: {fontSize: 25, color: 'black'},
        containerStyle: {width: '95%', backgroundColor: '#fff271', padding: 10},
        size: buttonSize,
      },
      {
        id: '4',
        ...
        color: 'black',
        labelStyle: {fontSize: 25, color: 'black'},
        containerStyle: {width: '95%', backgroundColor: '#f2963b', padding: 10},
        size: buttonSize,
      },
      {
        id: '5',
        ...
        color: 'black',
        labelStyle: {fontSize: 25, color: 'black'},
        containerStyle: {width: '95%', backgroundColor: '#ff4e55', padding: 10},
        size: buttonSize,
      },
    ],
    [],
